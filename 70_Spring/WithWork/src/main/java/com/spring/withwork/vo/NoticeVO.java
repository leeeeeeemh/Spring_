...
public class NoticeVO {
	...
	public NoticeVO(int m_num, int room_id, String time, String message, String attfile, int g_num,
			String role, String g_name, int cm_num, int cj_num, String searchMember) {
		super();
		this.m_num = m_num;
	...
	public String toString() {
		return "NoticeVO [m_num=" + m_num + ", room_id=" + room_id + ", time=" + time + ", message=" + message
				+ ", attfile=" + attfile + ", g_num=" + g_num + ", role=" + role + ", g_name="
				+ g_name + ", cm_num=" + cm_num + ", cj_num=" + cj_num + ", searchMember=" + searchMember + "]";
	}
